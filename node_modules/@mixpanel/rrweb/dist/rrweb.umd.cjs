...
class Mirror22 {
  ...
  removeNodeFromMap(n2, _permanent) {
    const id = this.getId(n2);
    this.idNodeMap.delete(id);
    if (n2.childNodes) {
...
class MutationBuffer {
  constructor() {
    ...
    __publicField(this, "cleanupRemovedNode", (node2) => {
      if (node2.nodeName === "IFRAME") {
        try {
...
class IframeManager {
  constructor(options) {
    ...
    __publicField(this, "iframeContentDocumentMap", /* @__PURE__ */ new WeakMap());
    __publicField(this, "iframeObserverCleanupMap", /* @__PURE__ */ new WeakMap());
    __publicField(this, "mirror");
    __publicField(this, "mutationCb");
